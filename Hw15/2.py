...
'''Количество образцов в выборке неравномерное, значит точность некоторых 
классов будет очень низкой (как в случае Normal-like и HER2-enriched
- самая низкая точность, Luminal A - очень высокая.'''